...
<sub>[previous](../acceleration/README.md#user-content-player-acceleration) • [home](../README.md#user-content-gms2-move-in-8-directions) • [next](../)</sub>
...
![alt_text](images/breakingFrictionGame.png)
